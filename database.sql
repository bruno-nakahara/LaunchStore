...
--to run seeds delete data from tables without deleting the tables
...
--Criar regra que vai acionar todas as vezes que solicitamos o DELETE dos produtos
...
--Criar uma VIEW onde será puxados somente dados ativos
CREATE VIEW products_without_deleted AS
SELECT * FROM products WHERE deleted_at IS NULL;

--Renomear a nossa VIES e TABLE
